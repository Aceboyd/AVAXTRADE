  ...
  const team = [
    {
      ...
      avatar: "AT",
      description:
        "Former Goldman Sachs executive with 15+ years in fintech and blockchain technology.",
    },
    {
      name: "Sarah Kim",
      role: "CTO & Co-Founder",
    ...
    },
    {
      ...
      avatar: "MC",
      description:
        "Cybersecurity expert with experience at major financial institutions and crypto exchanges.",
    },
  ];
  ...
  const values = [
    {
      ...
      description:
        "We prioritize the security of your assets above all else, implementing industry-leading protection measures.",
    },
    {
      icon: (
        <svg
      ...
      title: "Innovation",
      description:
        "Constantly pushing the boundaries of what's possible in cryptocurrency trading and technology.",
    },
    {
      icon: (
        <svg
      ...
      title: "Community",
      description:
        "Building a global community of traders and investors who support each other's success.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            Founded in 2018, AVAXTRADE has grown to become one of the world's
            most trusted cryptocurrency exchanges. We're on a mission to make
            digital assets accessible, secure, and profitable for everyone.
          </p>
        </div>
        ...
        <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-xl p-12 mb-20">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 leading-relaxed max-w-4xl mx-auto">
              ...
              secure, user-friendly platform that empowers individuals and
              institutions to participate in the digital economy. We believe
        ...
        <div className="text-center mt-20">
          <div className="bg-gradient-to-r from-blue-500/10 to-cyan-400/10 border border-blue-500/20 rounded-xl p-12">
            <h3
              ...
              style={{ fontFamily: "'Bodoni Moda', serif" }}
            >
              Ready to Join AVAXTRADE?
            </h3>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Start your cryptocurrency trading journey with the platform
