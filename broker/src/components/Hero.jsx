...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative overflow-hidden pt-4 pb-4 sm:pt-8 sm:pb-8"
    >
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left lg:order-1">
            ...
            <div className="inline-flex items-center bg-gradient-to-r from-blue-500/20 to-cyan-400/20 border border-blue-500/30 rounded-full px-2.5 py-1 sm:px-3 sm:py-1.5 lg:px-4 lg:py-2 mb-3 sm:mb-4 lg:mb-6">
              ...
              <span className="text-blue-300 text-xs sm:text-xs lg:text-sm font-medium">
                #1 Crypto Trading Platform
              </span>
            </div>

            {/* Main Headline */}
            <h1 className="font-tapestry text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mb-3 sm:mb-4 lg:mb-6 leading-tight">
              <span className="block text-white mb-1 sm:mb-1.5 lg:mb-2">
                Trade Crypto with
              </span>
            ...
            {/* Subheadline */}
            <p className="font-bilbo text-sm sm:text-base lg:text-lg xl:text-xl text-gray-300 mb-4 sm:mb-6 lg:mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed px-1 sm:px-2 lg:px-0">
              Experience next-generation cryptocurrency trading with advanced
              security, real-time analytics, and seamless execution. Join over
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3 lg:gap-4 lg:grid-cols-4 text-center lg:text-left px-1 sm:px-2 lg:px-0">
              <div className="flex flex-col items-center lg:flex-row lg:items-start space-y-1 lg:space-y-0 lg:space-x-3">
                ...
                <div>
                  <p className="text-white text-xs sm:text-xs lg:text-sm font-semibold">
                    Bank-Level
                  </p>
          ...
          <div className="relative lg:order-2">
              ...
              <div className="relative bg-gray-900/80 backdrop-blur-sm border border-gray-700 rounded-2xl p-2.5 sm:p-3 lg:p-6 shadow-2xl">
                ...
                <div className="absolute -top-1.5 -right-1.5 sm:-top-2 sm:-right-2 lg:-top-4 lg:-right-4 bg-green-500/90 backdrop-blur-sm text-white px-1.5 py-0.5 sm:px-2 sm:py-1 lg:px-4 lg:py-2 rounded-lg shadow-lg">
                  <div className="flex items-center space-x-1 sm:space-x-1.5 lg:space-x-2">
                    ...
                    <span className="text-xs sm:text-xs lg:text-sm font-semibold">
                      +24.5%
                    </span>
                  </div>
                  <p className="text-xs text-green-100 hidden sm:hidden lg:block">
                    Portfolio Growth
                  </p>
                </div>
                ...
                <div className="absolute -bottom-1.5 -left-1.5 sm:-bottom-2 sm:-left-2 lg:-bottom-4 lg:-left-4 bg-blue-500/90 backdrop-blur-sm text-white px-1.5 py-0.5 sm:px-2 sm:py-1 lg:px-4 lg:py-2 rounded-lg shadow-lg">
                  ...
                  <p className="text-xs text-blue-100 hidden sm:hidden lg:block">
                    Total Balance
                  </p>
                </div>
              </div>
            ...
            <div className="absolute top-2 -left-2 sm:top-4 sm:-left-4 lg:top-8 lg:-left-8 w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-r from-orange-500/20 to-yellow-500/20 rounded-xl flex items-center justify-center backdrop-blur-sm border border-orange-500/30 animate-pulse hidden xs:flex">
              <span className="text-orange-400 font-bold text-xs sm:text-sm lg:text-lg">
                ₿
              </span>
            </div>

            <div
              className="absolute bottom-2 -right-2 sm:bottom-4 sm:-right-4 lg:bottom-8 lg:-right-8 w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-r from-purple-500/20 to-blue-500/20 rounded-xl flex items-center justify-center backdrop-blur-sm border border-purple-500/30 animate-pulse hidden xs:flex"
              style={{ animationDelay: '1s' }}
            >
              <span className="text-purple-400 font-bold text-xs sm:text-sm lg:text-lg">
                Ξ
              </span>
            </div>

            <div
              className="absolute top-1/2 -left-4 sm:-left-6 lg:-left-12 w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-r from-green-500/20 to-cyan-500/20 rounded-lg flex items-center justify-center backdrop-blur-sm border border-green-500/30 animate-pulse hidden sm:flex"
              style={{ animationDelay: '2s' }}
            >
              <span className="text-green-400 font-bold text-xs sm:text-xs lg:text-sm">
                ₳
              </span>
            </div>
          </div>
      ...
      <div
        className="absolute bottom-20 right-10 w-16 h-16 border border-cyan-400/30 rounded-full animate-pulse hidden xl:block"
        style={{ animationDelay: '1s' }}
      ></div>
    </section>
  );
